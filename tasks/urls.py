...
urlpatterns = [
    ...
    path('task_add/<int:pk>/update_employee',views.update_employee_task,name='update_employee'),
    path('task_add/<int:pk>/update_reason',views.update_reason_task,name='update_reason'),
